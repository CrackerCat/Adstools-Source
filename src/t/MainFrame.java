...
public class MainFrame extends JFrame implements HandleCallback {
    ...
    public MainFrame() {
        initComponents();
        setStatus("Try Clear framework cache if compiling APK fails" + "\n" + "\nAfter you injeted the ads, make sure to test on all Android versions as" + "\npossible as you can because it may not work on some Android versions" + "\nWe try hard to support all versions and apps/games");
        ...
        try {
            if (isSplashChked.contains("true")) cb_change_splash.setSelected(true);
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        this.jLabel2.setText("Google AdMob ID (Interstitial only)");
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGap(211, 211, 211).addComponent(this.jLabel5).addGap(251, 251, 251)).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING).addComponent(this.jLabel4) //Credit
                        .addComponent(this.jLabel1)).addPreferredGap(ComponentPlacement.UNRELATED) //APK
                .addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.tv_path_file, -1, 480, 32767).addComponent(this.tv_credit)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(this.btn_select_file, -2, 90, -2).addComponent(this.cb_remain)).addContainerGap()))).addComponent(this.jScrollPane1).addGroup(jPanel1Layout.createSequentialGroup().addGap(29, 29, 29).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false).addGroup(Alignment.LEADING, jPanel1Layout.createSequentialGroup().addGap(89, 89, 89).addComponent(this.tv_notify, -2, 349, -2).addGap(0, 115, 32767)).addGroup(jPanel1Layout.createSequentialGroup().addGap(18, 18, 18).addComponent(this.btn_buildsign).addGap(89, 89, 89).addComponent(this.btn_handle, -2, 134, -2).addGap(73, 73, 73).addComponent(this.btn_open_folder))).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.jLabel3).addGap(27, 27, 27)).addGroup(Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addComponent(this.jLabel2).addGap(18, 18, 18))).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.cb_change_splash).addGap(26, 26, 26)).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.tv_adID_1, -1, 459, 32767).addComponent(this.tv_adID_2))))).addContainerGap(-1, 32767)).addGroup(Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.jLabel6).addGap(191, 191, 191)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGap(8, 8, 8).addComponent(this.jLabel5).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.tv_path_file, -2, 34, -2) //1st textbox ID
                        .addComponent(this.jLabel1)).addComponent(this.btn_select_file, Alignment.TRAILING, -2, 34, -2)).addGap(18, 18, 18).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.tv_credit, -2, 34, -2).addComponent(this.jLabel4) //2nd textbox ID
                        .addComponent(this.cb_remain)).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.btn_handle).addComponent(this.btn_buildsign).addComponent(this.btn_open_folder)).addGap(17, 17, 17).addComponent(this.tv_notify).addGap(11, 11, 11).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.cb_change_splash)).addGap(18, 18, 18).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.tv_adID_1, -2, 28, -2).addComponent(this.jLabel2)).addPreferredGap(ComponentPlacement.UNRELATED) //ID 1
                .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.tv_adID_2, -2, 0, -2).addComponent(this.jLabel3)).addPreferredGap(ComponentPlacement.UNRELATED).addComponent(this.jLabel6).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.jScrollPane1, -2, 171, -2)));
    ...
    public void decodeComplete() {
        ...
        if (this.cb_change_splash.isSelected()) {
            this.mainThread.addTask(new ChangeSplash(new File(this.pathFolderTools + "\\splash.png"), new File[]{new File(this.dirApkFile + "\\assets\\bin\\Data\\splash.png"), new File(this.dirApkFile + "\\assets\\splash.png"), new File(this.dirApkFile + "\\res\\raw\\\\splash.png")}));
            this.mainThread.addTask(new ChangeSplash(new File(this.pathFolderTools + "\\loading_logo.png"), new File[]{new File(this.dirApkFile + "\\res\\drawable\\\\loading_logo.png")}));
        }
    ...
    public void changeManfeMutidexComplete() {
        ...
        this.mainThread.addTask(new BuildApk(this.dirApkFile, this.dirApkFile + "_signed.apk", this));
    }

    //Compile complete
    public void buildComplete() {
        setStatus("I: Compiled -> Signing");
        this.mainThread.addTask(new SignerApk(this.dirApkFile + "_signed.apk", this.dirApkFile + "_signed.apk", this));
    }
