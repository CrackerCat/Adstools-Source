...
public class ChangeManfei implements Runnable {
    ...
    public void haldleManife() throws IOException {
        ...
        try {
            ...
            while (line != null) {
                ...
                } else if ((!line.contains("android.intent.action.MAIN")) && (!line.contains("android.intent.category.LAUNCHER"))) {
                    this.lineContents.add(line);
                    countLine++;
                }
